defmodule K8s.Discovery.Driver.File do
  ...
  @spec get_versions(keyword) :: {:ok, list(binary)} | {:error, :enoent | Jason.DecodeError}
  ...
  @spec get_resources(binary, keyword) ::
          {:ok, list(binary)} | {:error, :enoent | Jason.DecodeError}
  ...
  @spec get_config(keyword) :: {:ok, map} | {:error, :enoent | Jason.DecodeError}
