defmodule K8s.Conn.PKITest do
  ...
  describe "cert_from_pem/1" do
    test "reads the certificate from a PEM file" do
      assert {:ok, _cert} = PKI.cert_from_pem("test/support/tls/certificate.pem")
    end
  end

  describe "cert_from_base64/1" do
    test "decodes the certificate from a base64 encoded string" do
      data =
      ...
      assert {:ok, _cert} = PKI.cert_from_base64(data)
    end
  end

  describe "private_key_from_pem/1" do
    test "reads the private key from a PEM file" do
      assert {:ok, {:RSAPrivateKey, _key}} = PKI.private_key_from_pem("test/support/tls/key.pem")
    end
  end

  describe "private_key_from_base64/1" do
    test "decodes the certificate from a base64 encoded string" do
      data =
      ...
      assert {:ok, {:RSAPrivateKey, _key}} = PKI.private_key_from_base64(data)
    end
  end
end
